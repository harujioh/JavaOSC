...
public class OSCPortOut extends OSCPort {
	 ...
	 * @param socket
	 *            the DatagramSocket to send from
	 */
	 ...
	 *             when failing to create a (UDP) out socket
	 */
	...
	/**
	 * Create an OSCPort that sends to "localhost", on the standard
	 * SuperCollider port.
	 * 
	 ...
	 * 
	 * @param aPacket
	 *            the bundle or message to send
	 * @throws IOException
	 *             if a (UDP) socket I/O error occurs
	 */
